<form action="/super-admin/tutorials/E-books-upload" method="post" enctype="multipart/form-data">
    <div class="card w-100">
        ...
        <div class="card-body">
            ...
            <div class="form-group input-group-sm">
                <input type="text" class="form-control" name="name" required placeholder="E-Book Name">
            ...
            <div class="form-group input-group-sm">
                <label for="" class="h3   btn-sm btn"> <input type="file" required class="form-control" name="book"> Upload
                    E-Books</label>
                <div  class="text-danger">
                   {{ $errors->first('book')}}
                </div>
            ...
            <div class="form-group input-group-sm row">
                <button class="btn btn-secondary btn-sm  mx-auto" type="submit">Save E-Book
                </button>
            </div>
        </div>
    </div>
